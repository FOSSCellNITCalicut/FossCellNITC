        ...
        <div className="row">
          ...
          <div className="footer_col">
            <ul>
              ...
              <li>
                <a href="https://www.fossmeet.net/">FOSSMeet'23</a>
              </li>
              <li>
                <a href="https://hasgeek.com/fossmeet_nitc/2019/">FOSSMeet'19</a>
              </li>
              <li>
                <a href="https://github.com/fosscell">Git Workshop</a>
              </li>
            </ul>
          </div>
          <div className="footer_col">
            <ul>
              ...
              <li>
                <a href="https://instagram.com/fosscellnitc?igshid=MzRlODBiNWFlZA==">
                  <FaInstagram />
                  &nbsp;&nbsp;Instagram
                </a>
              </li>
              <li>
                <a href="https://twitter.com/FOSSCell?s=20">
                  <FaTwitter />
                  &nbsp;&nbsp;Twitter
                </a>
              </li>
